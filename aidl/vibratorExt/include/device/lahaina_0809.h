...
static std::unordered_map<Effect, std::vector<std::pair<std::string, std::string>>> EFFECTS_MAP_LAHAINA {
    // AOSP effects
    { Effect::CLICK, {
        { RTP_PATH, "0" },
        { DURATION_PATH, "13" },
...
static std::vector<std::pair<std::string, std::string>> VMAX_GAIN_LIST_ALARM_NOTIFICATION_LAHAINA {
    { "0x0c", "0x36" },
    { "0x0c", "0x45" },
    { "0x11", "0x54" },
    { "0x11", "0x63" },
...
static std::vector<std::pair<std::string, std::string>> VMAX_GAIN_LIST_DURATION_LAHAINA {
    { "0x02", "0x12" },
    { "0x02", "0x17" },
    { "0x04", "0x1c" },
    { "0x04", "0x21" },
...
static std::vector<std::pair<std::string, std::string>> VMAX_GAIN_LIST_HAPTIC_LAHAINA {
    { "0x02", "0x3f" },
    { "0x02", "0x46" },
    { "0x02", "0x4d" },
    { "0x04", "0x54" },
...
class lahaina_0809_vibrator : public LedVibrator {
public:
    lahaina_0809_vibrator() : LedVibrator(
        &UNIFIED_LEVEL_RANGE_CONFIG,
        EFFECTS_MAP_LAHAINA,
        VMAX_GAIN_LIST_ALARM_NOTIFICATION_LAHAINA,
        VMAX_GAIN_LIST_DURATION_LAHAINA,
        VMAX_GAIN_LIST_HAPTIC_LAHAINA
    ) {}
